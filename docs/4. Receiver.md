...
```java
  ...
  IntentFilter getBeaconIntentFilter = 
    new IntentFilter("receiver_custom_event");
  String permission = 
    sharedPreferences.getString("Application_ID", "") +
      ".permission.GET_ALL_TYPE_BEACONS";
  context.registerReceiver(CustomEventReceiver, getBeaconIntentFilter, permission, null);
```
...
```java
  SharedPreferences sharedPreferences = 
    context.getSharedPreferences(null, Context.MODE_PRIVATE);
  IntentFilter getBeaconIntentFilter = 
    new IntentFilter("receiver_custom_advertise_event");
  String permission = 
    sharedPreferences.getString("Application_ID", "") +
      ".permission.GET_ALL_TYPE_BEACONS";
  context.registerReceiver(CustomAdvertiseEventReceiver, getBeaconIntentFilter, permission, null);
```
+ Get the Broadcast Receiver bundle content
```java
...
```java
  SharedPreferences sharedPreferences = 
    context.getSharedPreferences(null, Context.MODE_PRIVATE);
  IntentFilter getBeaconIntentFilter = 
    new IntentFilter("receiver_add_favorite");
  String permission = 
    sharedPreferences.getString("Application_ID", "") +
      ".permission.GET_ALL_TYPE_BEACONS";
  context.registerReceiver(AddFavoriteReceiver, getBeaconIntentFilter, permission, null);
```
+ Get the Broadcast Receiver bundle content
```java
...
```java
  SharedPreferences sharedPreferences = 
    context.getSharedPreferences(null, Context.MODE_PRIVATE);
  IntentFilter getBeaconIntentFilter = 
    new IntentFilter("receiver_notification");
  String permission = 
    sharedPreferences.getString("Application_ID", "") +
      ".permission.GET_ALL_TYPE_BEACONS";
  context.registerReceiver(NotificationReceiver, getBeaconIntentFilter, permission, null);
```
+ Get the Broadcast Receiver bundle content
```java
...
```java
  SharedPreferences sharedPreferences = 
    context.getSharedPreferences(null, Context.MODE_PRIVATE);
  IntentFilter getBeaconIntentFilter = 
    new IntentFilter("receiver_position_beacon");
  String permission = 
    sharedPreferences.getString("Application_ID", "") +
      ".permission.GET_ALL_TYPE_BEACONS";
  context.registerReceiver(PositionBeaconReceiver, getBeaconIntentFilter, permission, null);
```
+ Get the Broadcast Receiver bundle content
```java
public class PositionBeaconReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getExtras() != null) {
            ...
            long RDistance = intent.getExtras().getLong("RDistance");
            long RSSI = intent.getExtras().getLong("RSSI");
            //===
